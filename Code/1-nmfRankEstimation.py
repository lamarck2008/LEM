...
if __name__ == "__main__":
  ...
  for i in range(nrun):
     ...
     plt.xlabel("Factors")
     plt.savefig(os.path.join(parent_path, "Result", os.path.basename(filename) + "." + str(i) + '.pdf'))

  with open(os.path.join(parent_path, "Result", os.path.basename(filename) + "." + "cophentic" + ".txt"), 'w') as f:
     for res in res_list:
